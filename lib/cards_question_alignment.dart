...
class CardsQuestionAlignment extends StatefulWidget
{
  final List data;
  final int index;
  CardsQuestionAlignment(BuildContext context,this.data,this.index)
  {
  ...
  @override
  _CardsQuestionState createState() => new _CardsQuestionState(this.data,this.index);
}

class _CardsQuestionState extends State<CardsQuestionAlignment> with SingleTickerProviderStateMixin
{
  final List data;
  final int length;
  _CardsQuestionState(this.data,this.length);
  int cardsCounter = 0;
  ...
  void initState()
  {
    ...
    // Init cards
    for (cardsCounter = 0; cardsCounter < length; cardsCounter++)
    {
